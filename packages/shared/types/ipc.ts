export const IpcChannel = {
  ...
  USER_GET_ALL_READING_PLANS: 'user:get-all-reading-plans',
  USER_SAVE_READING_PLAN: 'user:save-reading-plan',
  USER_UPDATE_READING_PLAN_PROGRESS: 'user:update-reading-plan-progress',
  USER_DELETE_READING_PLAN: 'user:delete-reading-plan',
